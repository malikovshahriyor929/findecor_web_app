                      ...
                      >
                        { message?.content?.trim() ==
                          ...
                          <div className="flex flex-col gap-3">
                            ...
                            <div
                              className={ `cursor-pointer !relative   flex items-center justify-evenly flex-col border border-[rgba(10,10,10,0.1)] rounded-lg    ${imgDetactSugetion && "hidden"
                                } ` }
                            >
                              <button
                                onClick={ () => {
                                ...
                                className={ ` cursor-pointer   py-2 px-2 w-full flex items-center justify-center text-sm font-medium text-[rgba(10,10,10,0.7)] ${hiddenOfAfterImg && "!cursor-not-allowed  "
                                  } ` }
                              >
                                I need furniture from this room.
                              </button>
                              <div className="h-px  w-[90%] bg-[rgba(10,10,10,0.1)]"></div>
                              <button
                                disabled={ hiddenOfAfterImg }
                                onClick={ () => {
                                  showProduct();
                                ...
                                className={ `w-full flex items-center cursor-pointer justify-center text-sm font-medium text-[rgba(10,10,10,0.7)]  py-2   ${hiddenOfAfterImg && "!cursor-not-allowed  "
                                  } ` }
                              >
