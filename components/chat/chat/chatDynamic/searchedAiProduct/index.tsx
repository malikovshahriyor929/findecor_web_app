        ...
        {currentItems?.map((value: ProductType, i: number) => {
          return (
            <div key={i} className="relative w-full ">
              <div
                className={`flex items-center flex-col bg-white p-2 rounded-lg shadow-[0_1px_2px_-0px_rgba(0,0,0,0.08),inset_0_-0px_0_0_rgba(0,0,0,0.12)] gap-4  max-[1382px]:p-2 relative w-full  ${
                  loading && "blur-sm "
                }   `}
              >
                <Image
